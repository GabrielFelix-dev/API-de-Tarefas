...
O projeto implementa um **CRUD completo** (Create, Read, Update e Delete) usando um banco de dados em memória, algo bem simples apenas para concretizar meu conhecimentos.
